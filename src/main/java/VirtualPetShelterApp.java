...
public class VirtualPetShelterApp {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.printf("%-10s %-10s %-10s %-10s\n", pet1.getPetName(), pet1.getHunger(), pet1.getThirst(),
					pet1.getBoredom());
			System.out.printf("%-10s %-10s %-10s %-10s\n", pet2.getPetName(), pet2.getHunger(), pet2.getThirst(),
					pet2.getBoredom());
			System.out.printf("%-10s %-10s %-10s %-10s\n", pet3.getPetName(), pet3.getHunger(), pet3.getThirst(),
					pet3.getBoredom());
			System.out.printf("%-10s %-10s %-10s %-10s\n", pet4.getPetName(), pet4.getHunger(), pet4.getThirst(),
					pet4.getBoredom());
